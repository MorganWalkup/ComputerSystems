...
LASERBUFFERSET:
	...
	MOV R8, R6				; Copy the value in R6 into R8
	MOV R7, R5				; Copy the value in R5 into R7
	MOV R6, R4				; Copy R4 to R6
	MOV R5, R3				; Copy R3 to R5
	MOV R4, R2				; Copy R2 to R4
	MOV R3, R1				; Copy R1 to R3
	MOV R2, ZH				; Copy ZH to R2
	MOV R1, ZL				; Copy ZL to R1
	RETI					; Return from interrupt
...
.org 0x1400
TABLEM: ; Janky
	.db 0x02, 0x40, 0xFF, 0x11, 0xC0, 0x20, 0x40, 0x2E, 0xBF, 0x3E, 0x40, 0x00, 0x11
.org 0x1440
TABLEN:
...
.org 0x1500
TABLEQ:
	.db 0x14, 0xC0, 0xFF, 0x02, 0xA0, 0x02, 0x5C, 0x14, 0x40, 0x29, 0x40, 0x3E, 0x5B, 0x3E, 0xA0, 0x29, 0xC0, 0x14, 0xC0, 0x00, 0xFF, 0x28, 0x5A, 0x3E, 0x40, 0x00, 0x11
.org 0x1540
TABLER:
...
.org 0x16C0
TABLEX:
	.db 0x02, 0xC0, 0xFF, 0x3E, 0x40, 0x00, 0xFF, 0x02, 0x40, 0x3E, 0xC0, 0x00, 0x11
.org 0x1700
TABLEY:
...
.org 0x18C0
TABLE5:
	.db 0x3E, 0xC0, 0xFF, 0x02, 0xC0, 0x02, 0x89, 0x3E, 0x89, 0x3E, 0x5D, 0x31, 0x40, 0x11, 0x40, 0x02, 0x5C, 0x00, 0x11
.org 0x1900
TABLE6:
