...
LR3:LDI R22, 17				; Load 27 into R22
...
LASERTESTPATTERN:
	...
	BREQ LASERTESTOFF		; If "laser off", branch to LASERTESTOFF
	CPI R16, 0xFF			; Compares the value in R16 to "laser on" code
	BREQ LASERTESTON		; If "laser on", branch to LASERTESTON
	; X-Coordinate
...
.org 0x1240
TABLEB:
	.db 0x02, 0x40, 0xFF, 0x02, 0xC0, 0x28, 0xC0, 0x3D, 0xAA, 0x3D, 0x96, 0x28, 0x82, 0x02, 0x82, 0x28, 0x82, 0x3D, 0x6E, 0x3D, 0x50, 0x28, 0x40, 0x02, 0x40, 0x11
.org 0x1280
TABLEC:
	.db 0xFF, 0x3D, 0xA0, 0x1D, 0xC0, 0x02, 0xA0, 0x02, 0x58, 0x1F, 0x40, 0x3D, 0x58, 0x11
.org 0x12C0
TABLED:
	.db 0xFF, 0x02, 0x40, 0x02, 0xC1, 0x28, 0xC0, 0x3D, 0x96, 0x3D, 0x6E, 0x28, 0x40, 0x02, 0x40, 0x11
.org 0x1300
TABLEE:
	.db 0xFF, 0x3D, 0xC0, 0x02, 0xC0, 0x02, 0x40, 0x3D, 0x40, 0x02, 0x40, 0x02, 0x82, 0x28, 0x82, 0x11
.org 0x1340
TABLEF:
	.db 0xFF, 0x3D, 0xC0, 0x02, 0xC0, 0x02, 0x40, 0x02, 0x82, 0x28, 0x82, 0x11
.org 0x1480
TABLEG:
	.db 0xFF, 0x3E, 0xA4, 0x33, 0xBF, 0x0D, 0xC0, 0x02, 0xA3, 0x02, 0x5A, 0x0D, 0x41, 0x32, 0x41, 0x3E, 0x58, 0x3E, 0x7C, 0x24, 0x7B, 0x11
.org 0x14C0
TABLEH:
	.db 0xFF, 0x02, 0xC0, 0x02, 0x41, 0x02, 0x82, 0x3E, 0x82, 0x3E, 0xC0, 0x3E, 0x40, 0x11
.org 0x1500
TABLEI:
	.db 0xFF, 0x02, 0xC0, 0x3E, 0xC0, 0x1F, 0xC0, 0x1F, 0x40, 0x02, 0x40, 0x3E, 0x40, 0x11
.org 0x1540
TABLEJ:
	.db 0xFF, 0x3E, 0xC0, 0x3E, 0x6F, 0x21, 0x40, 0x02, 0x6F, 0x11
.org 0x1580
TABLEK:
	.db 0xFF, 0x02, 0xC0, 0x02, 0x82, 0x3E, 0xC0, 0x02, 0x82, 0x3E, 0x40, 0x02, 0x82, 0x02, 0x40, 0x11
.org 0x15C0
TABLEL:
	.db 0xFF, 0x02, 0xC0, 0x02, 0x40, 0x3E, 0x40, 0x11
.org 0x1600
TABLEM:
	.db 0xFF, 0x02, 0x40, 0x11, 0xC0, 0x20, 0x40, 0x2E, 0xBF, 0x3E, 0x40, 0x11
.org 0x1640
TABLEN:
	.db 0xFF, 0x02, 0x40, 0x02, 0xC0, 0x3E, 0x40, 0x3E, 0xC0, 0x11
.org 0x1680
TABLEO:
	.db 0xFF, 0x14, 0xC0, 0x02, 0xA0, 0x02, 0x5C, 0x14, 0x40, 0x29, 0x40, 0x3E, 0x5B, 0x3E, 0xA0, 0x29, 0xC0, 0x14, 0xC0, 0x11
.org 0x16C0
TABLEP:
	.db 0xFF, 0x02, 0x40, 0x02, 0xC0, 0x3E, 0xC0, 0x3E, 0x82, 0x02, 0x82, 0x11
.org 0x1700
TABLEQ:
...
TABLESTAR: ; Character table for the test pattern (square for now)
	.db 0xFF, 0x01, 0x01, 0x01, 0xFE, 0xFE, 0xFE, 0xFE, 0x01, 0x01, 0x01, 0x00, 0x11